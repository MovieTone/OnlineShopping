...
<body>
	...
	<div class="wrap">
		<div class="login">
			<h3 align="center">Log in as a manager</h3>
			<div class="login_container">
				...
				<form name="sign-form" method="post" action="managing" id="login-form" role="form" onsubmit="return isValidLogIn()">
					...
					<div class="form-group">
						...
						<input required minlength="1" type="password" name="password" id="login_pass"></input>
					</div>
					<div class="clear">&nbsp;</div>
					<div class="form-group">
